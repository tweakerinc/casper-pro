...
Casper keeps CrossPointΓÇÖs stable reader core, and CrossInks AMAZING Stat Tracking, and adds a redesign to the UI, from thoughtful long-press menus that bring your settings where they need to be, to completely customizable **Reader UI**, **Synopsis Viewer**, and **StarDict Dictionary**
